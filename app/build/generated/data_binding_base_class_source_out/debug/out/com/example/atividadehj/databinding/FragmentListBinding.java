...
public final class FragmentListBinding implements ViewBinding {
  ...
  private FragmentListBinding(@NonNull LinearLayout rootView, @NonNull Button btnAdd,
  ...
  public static FragmentListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentListBinding((LinearLayout) rootView, btnAdd, recyclerView);
    }
